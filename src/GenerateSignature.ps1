function genSig
{
    ...
    $Session = New-PSSession DC01 -Credential $adminCreds -ErrorAction Inquire
...
lang=EN-US style='color:black;mso-ansi-language:EN-US'>Med venlig hilsen / Kind
regards</span><span lang=EN-GB style='mso-ansi-language:EN-GB'><br>
 ...
 height:69pt'>
 <v:imagedata src="new_files/image001.jpg" o:title="image002"/>
</v:shape><![endif]--><![if !vml]><img width=243 height=92
src="new_files/image002.jpg" v:shapes="_x0000_i1025"><![endif]><span
lang=EN-GB style='mso-ansi-language:EN-GB'><br>
</span><b><span lang=EN-US style='color:black;mso-ansi-language:EN-US'>$($userdata.Name)</span></b><span lang=EN-US style='color:black;mso-ansi-language:
EN-US'><br>
$($userdata.title), $($userdata.department)</span><span lang=EN-GB
style='mso-ansi-language:EN-GB'><br>
<br>
</span><span lang=EN-US style='color:black;mso-ansi-language:EN-US'>$Company <br>
Edisonvej 4 <br>
7100 Vejle <br>
Denmark</span><span lang=EN-GB style='mso-ansi-language:EN-GB'><br>
<br>
</span><b><span lang=EN-US style='color:black;mso-ansi-language:EN-US'>Mail: </span></b><span
lang=EN-US style='color:black;mso-ansi-language:EN-US'><a
href="$($userdata.mail)"><span style='color:black'>$($userdata.mail)</span></a><br>
<b>Office: </b>+45 7943 3000<o:p></o:p></span></p>
...
<meta name=Generator content="Microsoft Word 15">
<meta name=Originator content="Microsoft Word 15">
<link rel=File-List href="reply_files/filelist.xml">
<link rel=Edit-Time-Data href="reply_files/editdata.mso">
<link rel=themeData href="reply_files/themedata.thmx">
<link rel=colorSchemeMapping href="reply_files/colorschememapping.xml">
<style>
</style>
</head>
...
mso-fareast-language:DA'>Med venlig hilsen / Kind regards<o:p></o:p></span><br />

<b><span lang=EN-US style='color:black;mso-ansi-language:
EN-US;mso-fareast-language:DA'>$($userData.Name)</b><br />
$($userData.Title), $($userData.Department)<o:p></o:p></span><br />
<br />
<span lang=EN-US style='color:black;mso-ansi-language:EN-US;
mso-fareast-language:DA'>$Company <br />

<span lang=EN-US style='color:black;mso-ansi-language:EN-US;
mso-fareast-language:DA'><o:p>&nbsp;</o:p></span><br />

<b><span lang=EN-US style='color:black;mso-ansi-language:
EN-US;mso-fareast-language:DA'>Mail: </span></b><span lang=EN-US
style='color:black;mso-ansi-language:EN-US;mso-fareast-language:DA'><a
href="mailto:$($userData.mail)"><span style='color:black'>$($userData.mail)</span></a><br />
...
"@
    ...
    $FolderRoot = "\\fil01\it$\Teknik\Vejle\streamline\test\GenSig"
    
    mkdir $FolderRoot\$User
